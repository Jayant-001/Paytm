...
const Send = () => {
  ...
  const handleSend = async (e) => {
    e.preventDefault();
    console.log(amount, searchParams.get("id"))
    try {
        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="space-y-4">
              ...
              <button onClick={handleSend} class="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-500 text-white">
                Initiate Transfer
              </button>
            </div>
          </div>
